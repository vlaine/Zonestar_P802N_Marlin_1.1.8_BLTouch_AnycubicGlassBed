...
#if ENABLED(MIXING_EXTRUDER)
extern uint8_t mixing_factor_buf[MIXING_STEPPERS];
extern uint8_t mixing_factor[MIXING_STEPPERS];
#if ENABLED(MIXING_COMPENSATION) 
extern int16_t mix_compensation_count[MIXING_STEPPERS];
#endif
#endif


#if ENABLED(ENABLE_AUTO_MIXING)
extern uint8_t auto_mixing_mode;
extern uint8_t auto_mixing_min;
extern uint8_t auto_mixing_max;
#endif
