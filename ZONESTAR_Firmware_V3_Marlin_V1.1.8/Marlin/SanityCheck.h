 ...
 */
  ...
  #elif ENABLED(BABYSTEP_ZPROBE_OFFSET) && ENABLED(ADJUST_Z_MIN_POS)
    #error "BABYSTEP_ZPROBE_OFFSET and ADJUST_Z_MIN_POS is not a valid combination."
...
#if HAS_BED_PROBE
  /**
   * Z_PROBE is incompatible with ADJUST_Z_MIN_POS
   */
  #if ENABLED(ADJUST_Z_MIN_POS)
    #error "You cannot use Z_PROBE with MANUALLY_Z_MIN_POS."
  #endif
...
static_assert(1 >= 0
    ...
    + 1
      ...
      && DISABLED(MKS_12864OLED_SSD1306) \
      && DISABLED(ZONESTAR_OLED12864) \
      && DISABLED(ZONESTAR_LCD2004_KNOB) \
      && DISABLED(ZONESTAR_LCD12864)
    + 1
  #endif
    ...
    + 1
      ...
      && DISABLED(ZONESTAR_LCD2004_ADCKEY)
    + 1
  #endif
