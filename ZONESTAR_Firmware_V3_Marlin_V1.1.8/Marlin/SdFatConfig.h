 ...
 */
//SS_PIN is be used to DATA signal in ZMIB board
...
#define SOFT_SPI_CS_PIN   	4 // Software SPI chip select pin for the SD
#define SOFT_SPI_MOSI_PIN 	5 // Software SPI Master Out Slave In pin
#define SOFT_SPI_MISO_PIN 	6 // Software SPI Master In Slave Out pin
#define SOFT_SPI_SCK_PIN  	7 // Software SPI Clock pin
#else
// Define software SPI pins so Mega can use unmodified 168/328 shields
