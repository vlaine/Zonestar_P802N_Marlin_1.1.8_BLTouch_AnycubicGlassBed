...
#define CONDITIONALS_POST_H
   ...
   */
      ...
      #else
        #define Z2_MAX_ENDSTOP_INVERTING Z2_MAX_ENDSTOP_INVERTING
		#define Z2_MAX_PIN Z2_MAX_PIN
      #endif
      ...
      #else
        #define Z2_MAX_ENDSTOP_INVERTING Z2_MIN_ENDSTOP_INVERTING
		#define Z2_MAX_PIN Z2_MIN_PIN
      #endif
  ...
  //
  #define HAS_FIL_RUNOUT2 (((EXTRUDERS > 1) || ENABLED(MIXING_EXTRUDER)) && PIN_EXISTS(FIL_RUNOUT2))
   ...
   */
	...
	#define WRITE_HEATER_BED(v) {WRITE(HEATER_BED_PIN, (v) ^ HEATER_BED_INVERTING); WRITE(HEATER_BED2_PIN, (v) ^ HEATER_BED_INVERTING);}
	#else
